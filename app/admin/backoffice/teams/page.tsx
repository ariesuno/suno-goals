...
export default function TeamsPage() {
  ...
  const filteredTeams = teams.filter(team => {
    ...
    // Filtros avançados
    if (filters.is_active !== undefined && team.is_active !== filters.is_active) {
      return false;
    }

    if (filters.min_members && team.member_count < filters.min_members) {
      return false;
    }

    if (filters.max_members && team.member_count > filters.max_members) {
      return false;
    }
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-white border border-neutral-2 rounded-lg p-4">
          <p className="text-xs font-medium text-neutral-5 uppercase tracking-wide mb-1">
            Times Ativos
          </p>
